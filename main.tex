...
\newcommand{\buttonStyle}[1]{\testsf{#1}\xspace}
...
\item Ok, we need to go back and create 3 more phrases in chain 01 (if you think about it, most dance/pop music travels in the 4/4 timing. That’s what we’re aiming for here to get you familiar with the program) %TODO
...
\item We’re going take our existing bassline section (phrase 01) and ‘clone’ it 3 times, so that we’re able to edit each one without it affecting the other. %TODO
